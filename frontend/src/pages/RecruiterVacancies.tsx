...
export default function RecruiterVacancies() {
  ...
  return (
    ...
    "
      ...
      >
        ...
        {vacancies.length > 0 && (
          <Button
            ...
            className="
              min-h-11 gap-2 rounded-xl px-5
      ...
      {openCount >= 5 && (
        <p
          className="mb-7 border-b pb-4 text-sm"
          style={{ borderColor: P.borderSub, color: P.amber }}
        >
                    ...
                    actions={
                      <>
                        <button
                          ...
                          className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_14px_rgba(168,85,247,0.35)]"
                          style={{
                        ...
                        {vacancy.status === "abierta" && (
                          <button
                            ...
                            className="flex items-center gap-1.5 rounded-lg border border-red-400/25 bg-red-500/10 px-3 py-1.5 text-xs font-medium text-red-300 transition-all duration-200 hover:-translate-y-0.5 hover:border-red-400/60 hover:bg-red-500/20 hover:text-red-200 hover:shadow-[0_0_14px_rgba(239,68,68,0.35)]"
                            style={{
            ...
            >
              <div className="mb-4 flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2
                    className="mt-1 font-title text-2xl font-semibold"
                    style={{ color: P.textSecondary }}
                  >
              ...
              <div className="opacity-80">
                {closedVacancies.map((vacancy) => (
                  <VacancyRow key={vacancy.id} vacancy={vacancy} mine />
                ))}
              </div>
            </section>
          )}
